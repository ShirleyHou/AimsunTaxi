...
def AAPIManage(time, timeSta, timeTrans, acycle):
    ...
    try:
        ...
        if clock2 == 90:
            print('In this 900sec, there were ', waitAccumulation, 'passengers were waiting and there were ', vacantAccumulation, 'Became vacant')
            meeting.append([meetingCount, wait, vacant, waitAccumulation, vacantAccumulation])
            waitAccumulation=0
            vacantAccumulation=0
            meetingCount = 0
            clock2 = 0
...
def AAPIFinish():
    import traceback, random
    try:
        global numberofpassenger,CARS,counter, testNumber
        fileName = 'statistics_test.txt'

        fileName2 = 'meeting_{}.txt'.format(testNumber)
        ...
        file2.write("meetingCount\t wait\t vacant\t waitAccumulation\t vacantAccumulation\n")
        for v in meeting:
            file2.write(str(v[0]))
            file2.write(',')
            file2.write(str(v[1]))
